...
export default function OrderTrackingPage() {
    ...
    const fetchOrder = async () => {
        ...
        const commentedIds = result.data.flatMap((order: any) =>
            order.OrderDetails
                                ...
                                {item.OrderDetails.map((o: any) => (
                                    <div key={o.id} className="p-5 !border-b !border-gray-200">
                                        <div className="flex gap-5">
                                            <img src={o.image} alt={o.name} className="w-34 h-34 object-cover rounded border border-gray-200 shadow-sm flex-shrink-0" />
                                            <div className="flex-1 min-w-0">
                                                <h3 className="!font-medium text-gray-900 !mb-2">{o.name}</h3>
                                                    ...
                                                    <div className="flex items-center justify-between p-4 bg-white shadow-sm">
                                                        ...
                                                        <div className="flex flex-col items-end">
                                                            ...
                                                            {item.order_status === "completed" && (
                                                                checkConmment.includes(o.id) ? (
                                                                    <button disabled className="text-gray-400">Đã đánh giá</button>
                                                                ) : (
                                                                    <button
                                    ...
                                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                                        <div className="flex flex-row-reverse">
                                            <div className='items-center flex !my-[15px]'>
                                                ...
                                                <p className="!text-[24px] !ml-2 !font-medium !text-red-500">{item.total_amount.toLocaleString()} đ</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="!bg-white !rounded-lg !max-w-2xl !w-full !max-h-[90vh] !overflow-y-auto">
                        ...
                        <div className="!p-6">
                            <div className="flex items-center !gap-4 !mb-6 !pb-6 !border-b">
                                <img src={reviewTarget.image} alt={reviewTarget.name} className="!w-20 !h-20 !object-cover !rounded" />
                                <div>
                                    <h3 className="!font-medium !text-gray-800 !m-0 !mb-1">{reviewTarget.name}</h3>
                                    <p className="!text-gray-500 !text-sm !m-0">Số lượng: x{reviewTarget.quantity}</p>
                                </div>
                            </div>
                            ...
                            {/* Comment */}
                            <div className="!mb-6">
                                <label className="!block !text-gray-700 !font-medium !mb-3">Nhận xét của bạn</label>
                                <textarea
                                    value={comment}
                                    ...
                                    rows={5}
                                />
                                <p className="!text-sm !text-gray-500 !mt-2 !mb-0">{comment.length} / 500 ký tự</p>
                            </div>
                            ...
                            <div className="flex !gap-3 justify-end !pt-4 !border-t">
                                ...
                                <button
                                    onClick={(e) => SubmitComment(e, reviewTarget.orderDetailId)}
                                    disabled={rating === 0}
